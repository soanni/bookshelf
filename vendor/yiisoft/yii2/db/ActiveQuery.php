...
class ActiveQuery extends Query implements ActiveQueryInterface
{
     ...
     *
     * ```php
     * // find all orders that contain book, and eager loading "book"
     * Order::find()->joinWith('book', true, 'INNER JOIN')->all();
     * // find all orders, eager loading "book", and sort the orders and book by the book names.
     * Order::find()->joinWith([
     *     'book' => function ($query) {
